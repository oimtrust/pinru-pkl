            ...
            <form class="col s12 m12" method="post">
                <div class="row">
                    <div class="input-field col s12">
                        <input type="text" readonly name="id_user" id="id_user" value="<?php echo $detailUser->id_user; ?>" onkeypress="return onlyNumber(event)" class="validate" autofocus>
                ...
                <div class="row">
                    <div class="input-field col s12">
                        <input type="text" name="nama_user" id="nama_user" value="<?php echo $detailUser->nama_user;?>" class="validate" >
                ...
                <div class="row">
                    <div class="input-field col s12">
                        ...
                        <select name="id_fakultas" class="id_fakultas">
                            <option value="<?php echo $detailUser->id_fakultas;?>" selected><?php echo $detailUser->nama_fakultas;?></option>
                            <?php
                            if ($row_count > 0) {
                ...
                <div class="row">
                    <div class="input-field col s12" >
                        <select name="id_prodi" id="id_prodi">
                            <option value="<?php echo $detailUser->id_prodi;?>" selected><?php echo $detailUser->nama_prodi;?></option>
                        </select>
                ...
                <div class="row">
                    <div class="input-field col s12">
                    <textarea id="alamat" name="alamat" class="materialize-textarea textarea"><?php echo $detailUser->alamat;?></textarea>
                ...
                <div class="row">
                    <div class="input-field col s12" >
                        <select name="status" id="status">
                            <option value="<?php echo $detailUser->status;?>" selected><?php echo $detailUser->status;?></option>
